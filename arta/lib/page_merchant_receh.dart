...
class MerchantReceh extends StatefulWidget {
  @override
  _MerchantRecehState createState() => _MerchantRecehState();
}

class _MerchantRecehState extends State<MerchantReceh> {
  String nominal = '0';
          ...
          RaisedButton(
            ...
            onPressed: () async {
              ...
              DocumentSnapshot ds = await Firestore.instance
                  ...
                  .document(user.uid)
                  .get();
              if (ds.data['saldo'] < int.parse(nominal)) {
                Fluttertoast.showToast(msg: 'Saldo anda tidak cukup');
                return;
              }

              DocumentReference doc =
                  ds.reference.collection('transaksi').document();
              ...
              if (success ?? false) {
                Fluttertoast.showToast(msg: 'Berhasil memberi kembalian');
                setState(() {
                  nominal = '0';
                });
              }
